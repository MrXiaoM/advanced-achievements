...
@DaggerGenerated
public final class LavaBucketsListener_Factory implements Factory {
      ...
      public LavaBucketsListener_Factory(Provider var1, Provider var2, Provider var3, Provider var4, Provider var5) {
      ...
      public LavaBucketsListener get() {
      ...
      public static LavaBucketsListener_Factory create(Provider var0, Provider var1, Provider var2, Provider var3, Provider var4) {
            return new LavaBucketsListener_Factory(var0, var1, var2, var3, var4);
      }

      public static LavaBucketsListener newInstance(YamlConfiguration var0, AchievementMap var1, CacheManager var2, AdvancedAchievements var3, YamlConfiguration var4) {
            return new LavaBucketsListener(var0, var1, var2, var3, var4);
      }
}
