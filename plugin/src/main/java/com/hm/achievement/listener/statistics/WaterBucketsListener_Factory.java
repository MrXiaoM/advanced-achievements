...
@DaggerGenerated
public final class WaterBucketsListener_Factory implements Factory {
      ...
      public WaterBucketsListener_Factory(Provider var1, Provider var2, Provider var3, Provider var4, Provider var5) {
      ...
      public WaterBucketsListener get() {
      ...
      public static WaterBucketsListener_Factory create(Provider var0, Provider var1, Provider var2, Provider var3, Provider var4) {
            return new WaterBucketsListener_Factory(var0, var1, var2, var3, var4);
      }

      public static WaterBucketsListener newInstance(YamlConfiguration var0, AchievementMap var1, CacheManager var2, AdvancedAchievements var3, YamlConfiguration var4) {
            return new WaterBucketsListener(var0, var1, var2, var3, var4);
      }
}
