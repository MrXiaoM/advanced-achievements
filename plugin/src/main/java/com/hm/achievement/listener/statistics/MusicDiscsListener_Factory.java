...
@DaggerGenerated
public final class MusicDiscsListener_Factory implements Factory {
      ...
      public MusicDiscsListener_Factory(Provider var1, Provider var2, Provider var3, Provider var4, Provider var5) {
      ...
      public static MusicDiscsListener_Factory create(Provider var0, Provider var1, Provider var2, Provider var3, Provider var4) {
            return new MusicDiscsListener_Factory(var0, var1, var2, var3, var4);
      }

      public static MusicDiscsListener newInstance(YamlConfiguration var0, AchievementMap var1, CacheManager var2, AdvancedAchievements var3, YamlConfiguration var4) {
            return new MusicDiscsListener(var0, var1, var2, var3, var4);
      }
}
