...
@DaggerGenerated
public final class BooksEditedListener_Factory implements Factory {
      ...
      public BooksEditedListener_Factory(Provider var1, Provider var2, Provider var3, Provider var4, Provider var5) {
      ...
      public BooksEditedListener get() {
      ...
      public static BooksEditedListener_Factory create(Provider var0, Provider var1, Provider var2, Provider var3, Provider var4) {
            return new BooksEditedListener_Factory(var0, var1, var2, var3, var4);
      }

      public static BooksEditedListener newInstance(YamlConfiguration var0, AchievementMap var1, CacheManager var2, AdvancedAchievements var3, YamlConfiguration var4) {
            return new BooksEditedListener(var0, var1, var2, var3, var4);
      }
}
