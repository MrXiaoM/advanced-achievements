...
@DaggerGenerated
public final class MonthCommand_Factory implements Factory {
      ...
      public MonthCommand_Factory(Provider var1, Provider var2, Provider var3, Provider var4, Provider var5, Provider var6) {
      ...
      public static MonthCommand_Factory create(Provider var0, Provider var1, Provider var2, Provider var3, Provider var4, Provider var5) {
            return new MonthCommand_Factory(var0, var1, var2, var3, var4, var5);
      }

      public static MonthCommand newInstance(YamlConfiguration var0, YamlConfiguration var1, StringBuilder var2, Logger var3, AbstractDatabaseManager var4, SoundPlayer var5) {
            return new MonthCommand(var0, var1, var2, var3, var4, var5);
      }
}
